		...
		function init_premium_support() {
			...
			if ( $this->ps_status )
                ...
                function support_expired() {
                        ...
                        echo "<div class='update-nag' style='display:none'>" . sprintf( __( "<strong style='color:red;'>Your license for SimpleMap has expired!</strong><br />You need to renew your license now for continued support and upgrades: <a href='%s' target='_blank'>Renew my license now</a>." ), $link ) . "</div>";  
                }
