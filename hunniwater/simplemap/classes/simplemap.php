		...
		function google_map_js_script() {
			...
			function createMarker( locationData ) {
				...
				markerOptions.position = locationData.point;
                                /*custom map marker location - ktrumble 02/13/2014*/
                                markerOptions.icon = new google.maps.MarkerImage( 
                                        '/wp-content/plugins/simplemap/inc/images/bee_mapIcon.png'
                                );
...
// Taxonomy lists               /* move category below phone -ktrumble 02132014*/
				for (jstax in locationData.taxes) {
					if ( locationData.taxes[jstax] != null && locationData.taxes[jstax] != '' ) {
				...
				<?php endif; ?>
                                ...
                                /* moved category below phone, above -ktrumble 02132014*/
				// Taxonomy lists
				//for (jstax in locationData.taxes) {
				//	if ( locationData.taxes[jstax] != null && locationData.taxes[jstax] != '' ) {
				//		html += '<div class="' + jstax + '_list"><small><strong>' + taxonomy_text[jstax] + ':</strong> ' + locationData.taxes[jstax] + '</small></div>';
		...
		function get_default_shortcode_atts() {
			...
			$atts = $tax_atts + array(
				...
				'search_form_cols'			=> 4, //ktrumble 02132014
