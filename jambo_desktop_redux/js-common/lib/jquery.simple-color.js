 ...
 */
            ...
            var select_callback = function (event) {
               ...
               // Build the chooser
                   ...
                   for (var i=0; i<options.colors.length; i++) {
                       ...
                       cell.css('float',           'left');
                       //WKRASKO 101812 - PNG-509
                       if(options.colors[i]!="none")
                        cell.css('backgroundColor', '#'+options.colors[i]);
                       else{
                        cell.html(_i18n_.get("GUI_REMOVE_USERCOLOR"));
                        cell.css('width','100%');
                        cell.css('color','#000000');
                        cell.css('fontSize','1.2em');
                        cell.css('padding','2px');
                        chooser.css('height',(options.totalHeight+4)+'px');
                       }
                       chooser.append(cell);
                       ...
                       cell.bind('click', {
                           ...
                           function(event) {
                               ...
                               if(!event.data.display_box.hasClass('dn'))//WKRASKO, quick mod so we don't have to show current color
    ...
    $.fn.closeSelector = function() {
        this.each( function(index) {
            ...
            if(!container.find('.simpleColorDisplay').hasClass('dn'))//WKRASKO, quick mod so we don't have to show current color
